            ...
            <div class="theme-container">  
                <div class="row agents-wrapper"> 
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="mdc-card o-hidden">
                            <a href="agent.html">
                                <img src="assets/images/agents/a-2.jpg" class="d-block mw-100"> 
                            </a>
                            <div class="p-3">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="mdc-card o-hidden">
                            <a href="agent.html">
                                <img src="assets/images/agents/a-3.jpg" class="d-block mw-100"> 
                            </a>
                            <div class="p-3">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="mdc-card o-hidden">
                            <a href="agent.html">
                                <img src="assets/images/agents/a-4.jpg" class="d-block mw-100">
                            </a>
                            <div class="p-3">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-3">
                        <div class="mdc-card o-hidden">
                            <a href="agent.html">
                                <img src="assets/images/agents/a-5.jpg" class="d-block mw-100"> 
                            </a>
                            <div class="p-3">
