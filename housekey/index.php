<?php include("header.php"); ?>  
    <main class="content-offset-to-top">  
            ...
            <div class="swiper-container h-100">
                <div class="swiper-wrapper h-100">  
                    <div class="swiper-slide">
                        <div class="slide-item swiper-lazy" data-background="assets/images/props/flat-1/1-big.jpg">
                            ...
                            <span class="d-none" data-slide-title="Hot Offer <br> <br>Modern and quirky flat"></span>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-item swiper-lazy" data-background="assets/images/props/house-1/5-big.jpg">
                            <div class="swiper-lazy-preloader"></div> 
                            <span class="d-none" data-slide-title="Hot Offer <br> <br>Comfortable family house"></span>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-item swiper-lazy" data-background="assets/images/props/office-2/6-big.jpg">
                            <div class="swiper-lazy-preloader"></div> 
                            <span class="d-none" data-slide-title="Hot Offer <br> <br>Luxury office space"></span>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-item swiper-lazy" data-background="assets/images/props/apartment/1-big.jpg">
                            <div class="swiper-lazy-preloader"></div> 
                            <span class="d-none" data-slide-title="Hot Offer <br> <br>Centrally located apartment"></span>
                ...
                <div class="slide-info column center-xs middle-xs">
                    <div id="active-slide-info" class="mdc-card p-4 column center-xs middle-xs">
                        ...
                        <a href=".php" class="mdc-button mdc-button--raised price"> 
                ...
                <div class="mdc-card main-content-header">  
                    <form action="javascript:void(0);" id="filters" class="search-wrapper"> 
                                ...
                                <div class="mdc-select mdc-select--outlined">
                                    ...
                                    <div class="mdc-select__menu mdc-menu mdc-menu-surface">
                                        <ul class="mdc-list">
                                            ...
                                            <li class="mdc-list-item" data-value="1">Any</li>
                                            <li class="mdc-list-item" data-value="2">1 Or More</li>
                                            <li class="mdc-list-item" data-value="3">2 Or More</li>
                                            <li class="mdc-list-item" data-value="4">3 Or More</li>
                                            <li class="mdc-list-item" data-value="5">4 Or More</li>
                                            <li class="mdc-list-item" data-value="6">5 Or More</li>
                                            <li class="mdc-list-item" data-value="7">6 Or More</li>
                                        </ul>
                                    </div>
                                </div> 
                        ...
                        <div class="row center-xs middle-xs p-2"> 
                            ...
                            <button class="mdc-button mdc-button--raised mx-2" type="button" id1="show-more-filters">
                                <span class="mdc-button__ripple"></span>
                                    ...
                                    <div class="mdc-card property-item grid-item column-4 full-width-page">
                                        ...
                                        <div class="property-content-wrapper"> 
                                            <div class="property-content">
                                                <div class="content">
                                                    <h1 class="title"><a href="property.php">Centrally located office</a></h1>
                                                    <p class="row address flex-nowrap">
                                                        <i class="material-icons text-muted">location_on</i>
                                                        <span>1052 W 91st St, Los Angeles</span>
                                                    </p>
                                                ...
                                                <div class="actions row between-xs middle-xs">
                                                    ...
                                                    <a href="property.php" class="mdc-button mdc-button--outlined">
                                                        <span class="mdc-button__ripple"></span>
                                ...
                                <div class="swiper-slide">
                                    <div class="mdc-card property-item grid-item column-4 full-width-page">
                                        ...
                                        <div class="property-content-wrapper"> 
                                            <div class="property-content">
                                                <div class="content">
                                                    <h1 class="title"><a href="property.php">Spacious and warm flat</a></h1>
                                                    <p class="row address flex-nowrap">
                                                        <i class="material-icons text-muted">location_on</i>
                                                        <span>55 W Jackson Blvd, Chicago, IL</span>
                                                    </p>
                                                    <div class="row between-xs middle-xs">
                                                        <h3 class="primary-color price">
                                                            <span>$ 1,450,000</span> 
                                ...
                                <div class="swiper-slide">
                                    <div class="mdc-card property-item grid-item column-4 full-width-page">
                                        ...
                                        <div class="property-content-wrapper"> 
                                            <div class="property-content">
                                                <div class="content">
                                                    <h1 class="title"><a href="property.php">House with a pool</a></h1>
                                                    <p class="row address flex-nowrap">
                                                        <i class="material-icons text-muted">location_on</i>
                                                        <span>5921 17th Ave S, Seattle, WA</span>
                                                    </p>
                                                    <div class="row between-xs middle-xs">
                                                        <h3 class="primary-color price">
                                                            <span>$ 4,500,000</span> 
                                ...
                                <div class="swiper-slide">
                                    <div class="mdc-card property-item grid-item column-4 full-width-page">
                                        ...
                                        <div class="property-content-wrapper"> 
                                            <div class="property-content">
                                                <div class="content">
                                                    <h1 class="title"><a href="property.php">Bright and sunny house</a></h1>
                                                    <p class="row address flex-nowrap">
                                                        <i class="material-icons text-muted">location_on</i>
                                                        <span>1400 W 44th St, Chicago, IL 6</span>
                                                    </p>
                                                    <div class="row between-xs middle-xs">
                                                        <h3 class="primary-color price">
                                ...
                                <div class="swiper-slide">
                                    <div class="mdc-card property-item grid-item column-4 full-width-page">
                                        ...
                                        <div class="property-content-wrapper"> 
                                            <div class="property-content">
                                                <div class="content">
                                                    <h1 class="title"><a href="property.php">Centrally located apartment</a></h1>
                                                    <p class="row address flex-nowrap">
                                                        <i class="material-icons text-muted">location_on</i>
                                                        <span>1627 Vine St, Los Angeles, CA 9</span>
                                                    </p>
                                                    <div class="row between-xs middle-xs">
                                                        <h3 class="primary-color price">
        ...
        <div class="section mt-3" style="padding-top: 0px;">
            <div class="px-3">
                <div class="theme-container">
                    <h1 class="section-title">For Rent</h1>  
                    <div class="properties-carousel">   
                        <div class="swiper-container carousel-outer"> 
                            <div class="swiper-wrapper">  
                                <div class="swiper-slide"> 
                                    <div class="mdc-card property-item grid-item column-4 full-width-page">
                                        <div class="thumbnail-section">
                                            <div class="row property-status">
                                                <span class="orange">For Rent</span>
                                            </div> 
                                            <div class="property-image"> 
                                                <div class="swiper-container">
                                                    <div class="swiper-wrapper"> 
                                        ...
                                        <div class="property-content-wrapper"> 
                                            <div class="property-content">
                                                <div class="content">
                                                    ...
                                                    <p class="row address flex-nowrap">
                                                        <i class="material-icons text-muted">location_on</i>
                                                        <span>1052 W 91st St, Los Angeles, CA </span>
                                                    </p>
                                                    <div class="row between-xs middle-xs">
                                                        <h3 class="primary-color price">
                                                            <span>$ 6,500 /month</span> 
                                        ...
                                        <div class="property-content-wrapper"> 
                                            <div class="property-content">
                                                <div class="content">
                                                    ...
                                                    <p class="row address flex-nowrap">
                                                        <i class="material-icons text-muted">location_on</i>
                                                        <span>55 W Jackson Blvd, Chicago, IL 606</span>
                                                    </p>
                                                    <div class="row between-xs middle-xs">
                                                        <h3 class="primary-color price">
                                                            <span>$ 1,450,000</span> 
                                        ...
                                        <div class="property-content-wrapper"> 
                                            <div class="property-content">
                                                <div class="content">
                                                    ...
                                                    <p class="row address flex-nowrap">
                                                        <i class="material-icons text-muted">location_on</i>
                                                        <span>1627 Vine St, Los Angeles, CA </span>
                                                    </p>
                                                    <div class="row between-xs middle-xs">
                                                        <h3 class="primary-color price">
                                                            <span>$ 5,600 /month</span> 
        ...
        <div class="section mt-3">
            <div class="px-3">
                <div class="theme-container">
                    <h1 class="section-title">Search By Places</h1>  
                    <div class="services-wrapper row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 p-2"> 
                            <div class="mdc-card h-100 w-100 text-center middle-xs p-3">            
                                <img src="assets/images/props/slide-3.jpg" style="width: 100%;height: 200px;">
                                <h2 class="capitalize fw-600 my-3 mp ds1" style="margin-bottom: 0px !important">ST PETERSBURG</h2>
                                <p class="text-muted fw-500">
                                    <a href="#" style="color:#000" class="ds">Under $200,000</a><br>
                                    <a href="#" style="color:#000" class="ds">$200,000 to $300,000</a><br>
                                    <a href="#" style="color:#000" class="ds">$300,000 to $400,000</a><br>
                                    <a href="#" style="color:#000" class="ds">$400,000 to $600,000</a><br>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 p-2"> 
                            <div class="mdc-card h-100 w-100 text-center middle-xs p-3">     
                                <img src="assets/images/props/slide-4.jpg" style="width: 100%;height: 200px;">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 p-2">  
                            <div class="mdc-card h-100 w-100 text-center middle-xs p-3">  
                                <img src="assets/images/props/slide-5.jpg" style="width: 100%;height: 200px;">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <p class="row middle-xs"><i class="material-icons primary-color">email</i><span class="mx-2 text-muted fw-500">lusia.m@Nancy EHLEN</span></p>
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <p class="mt-3 text-muted fw-500">Phasellus sed metus leo. Donec laoreet, lacus ut suscipit convallis, erat enim eleifend nulla, at sagittis enim urna et lacus.</p>                                    
                                            <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">Nancy EHLEN</span></p>
                                            <p class="row middle-xs"><i class="material-icons primary-color">email</i><span class="mx-2 text-muted fw-500">andy.w@Nancy EHLEN</span></p>
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <p class="mt-3 text-muted fw-500">Phasellus sed metus leo. Donec laoreet, lacus ut suscipit convallis, erat enim eleifend nulla, at sagittis enim urna et lacus.</p>                                    
                                            <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">Nancy EHLEN</span></p>
                                            <p class="row middle-xs"><i class="material-icons primary-color">email</i><span class="mx-2 text-muted fw-500">tereza.s@Nancy EHLEN</span></p>
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <p class="mt-3 text-muted fw-500">Phasellus sed metus leo. Donec laoreet, lacus ut suscipit convallis, erat enim eleifend nulla, at sagittis enim urna et lacus.</p>                                    
                                            <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">Nancy EHLEN</span></p>
                                            <p class="row middle-xs"><i class="material-icons primary-color">email</i><span class="mx-2 text-muted fw-500">michael.b@Nancy EHLEN</span></p>
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <p class="mt-3 text-muted fw-500">Phasellus sed metus leo. Donec laoreet, lacus ut suscipit convallis, erat enim eleifend nulla, at sagittis enim urna et lacus.</p>                                    
                                            <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">Nancy EHLEN</span></p>
                                            <p class="row middle-xs"><i class="material-icons primary-color">email</i><span class="mx-2 text-muted fw-500">michelle.o@Nancy EHLEN</span></p>
                                            <p class="row middle-xs"><i class="material-icons primary-color">call</i><span class="mx-2 text-muted fw-500">(267) 388-1637</span></p>
                                            <div class="row pb-3">
                                                <div class="divider"></div>
                                            </div> 
