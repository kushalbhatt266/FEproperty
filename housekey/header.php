...
<html lang="en">
 ...
 <head>
    ...
    <title> Noah Bressack | 813-494-2595 | Tampa FL Homes for Sale</title> 
            ...
            <div class="vertical-menu">   
                <div> 
                    <a href="javascript:void(0);" class="mdc-button"> 
                        ...
                        <span class="mdc-button__label">Home1</span>
                    </a>  
                  
                </div>   
                <div>
                    <a href="properties.php" class="mdc-button">
                        <span class="mdc-button__ripple"></span>
                ...
                <div class="mdc-menu-surface--anchor"> 
                    ...
                    <div class="mdc-menu mdc-menu-surface">
                        <div class="mdc-list"> 
                            <div> 
                                <a href="property.php" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Single Property</span> 
                                </a>  
                            </div><div> 
                                <a href="agents.php" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Agents</span> 
                                </a>  
                            </div>
                            <div> 
                                <a href="agent.php" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                            ...
                            <div> 
                                <a href="faqs.php" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">FAQs</span> 
                                </a>  
                            </div>
                            <div> 
                                <a href="pricing.php" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                                    <span class="mdc-button__label">Pricing</span> 
                                </a>  
                            </div>
                            <div> 
                                <a href="terms.php" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                            ...
                            <div> 
                                <a href="404.php" class="mdc-button"> 
                                    <span class="mdc-button__ripple"></span>
                ...
                <div>
                    <a href="contact.php" class="mdc-button">
                        <span class="mdc-button__ripple"></span>
                        <span class="mdc-button__label">Contact</span> 
                    </a> 
                </div> 
                <div>
                    <a href="about.php" class="mdc-button">
                        <span class="mdc-button__ripple"></span>
                ...
                <div class="row start-xs middle-xs">  
                    ...
                    <div class="row start-xs middle-xs fw-500 d-none d-md-flex d-lg-flex d-xl-flex"> 
                        <span class="d-flex center-xs middle-xs item">
                            ...
                            <span class="px-1"> Noah 813-494-2595 </span>
                        </span>
                        <span class="d-flex center-xs middle-xs item">
                            <i class="material-icons mat-icon-sm">call</i>
                            <span class="px-1"> Maxwell 727-641-2686</span>
                        </span>
                        ...
                        <span class="d-flex center-xs middle-xs item">
                            ...
                            <span class="px-1">listing@feelgreatrealestate.com</span>
                        </span>  
                    </div>       
                </div> 
                    ...
                    <div class="mdc-menu-surface--anchor"> 
                        ...
                        <div class="mdc-menu mdc-menu-surface user-menu">
                            <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical" tabindex="-1">
                                ...
                                <li>
                                    <a href="favorites.php" class="mdc-list-item" role="menuitem">
                                ...
                                <li role="separator" class="mdc-list-divider m-0"></li>
                                <li>
                                    <a href="login.php" class="mdc-list-item" role="menuitem">
        ...
        <div id="main-toolbar" class="mdc-elevation--z2">
            <div class="theme-container row between-xs middle-xs h-100"> 
                <a class="logo" href="index.php"> 
                   <img src="assets/images/main_logo-textchanges.png" style="width: 212px;height: 44px;"> 
                </a>  
                        ...
                        <a href="javascript:void(0);" class="mdc-button menu-item-has-children">
                         ...
                         <div class="mdc-menu mdc-menu-surface">
                            <div class="mdc-list"> 
                                ...
                                <div> 
                                    <a href="properties-sold.php" class="mdc-button"> 
                                        <span class="mdc-button__ripple"></span>
                    ...
                    <div class="mdc-menu-surface--anchor">
                        <a href="javascript:void(0);" class="mdc-button menu-item-has-children">
                         ...
                         <div class="mdc-menu mdc-menu-surface">
                            <div class="mdc-list"> 
                                <div> 
                                    <a href="toolbar-1.php" class="mdc-button"> 
                                        <span class="mdc-button__ripple"></span>
                    ...
                    <div class="mdc-menu-surface--anchor"> 
                        ...
                        <div class="mdc-menu mdc-menu-surface">
                            <div class="mdc-list"> 
                                ...
                                <div>     <a href="properties.php" class="mdc-button">
                                        <span class="mdc-button__ripple"></span>
                         ...
                         <div class="mdc-menu mdc-menu-surface">
                            <div class="mdc-list"> 
                                ...
                                <div> 
                                     <a href="properties.php" class="mdc-button">
                                        <span class="mdc-button__ripple"></span>
                                        <span class="mdc-button__label">Tips for Buyers</span> 
                                    </a>  
                                </div>
                                <div> 
                                      <a href="properties.php" class="mdc-button"> 
                                ...
                                <div> 
                                      <a href="properties.php" class="mdc-button">
                                        <span class="mdc-button__ripple"></span>
                                        <span class="mdc-button__label">Tips for Sellers</span> 
                                    </a>  
                                </div>
                                <div> 
                                      <a href="properties.php" class="mdc-button">
                                        <span class="mdc-button__ripple"></span>
                                        <span class="mdc-button__label">Homeowner Information</span> 
                                    </a>  
                                </div>
                                <div> 
                                      <a href="properties.php" class="mdc-button">
                                        <span class="mdc-button__ripple"></span>
                                        <span class="mdc-button__label">Title and Escrow Information</span> 
                                    </a>  
                                </div>
                                <div> 
                                      <a href="properties.php" class="mdc-button">
                                        <span class="mdc-button__ripple"></span>
                                        <span class="mdc-button__label">Mortgage Information</span> 
                                    </a>  
                                </div>
                                <div> 
                                     <a href="properties.php" class="mdc-button">
                         ...
                         <div class="mdc-menu mdc-menu-surface">
                            <div class="mdc-list"> 
                                ...
                                <div> 
                                    <a href="about.php" class="mdc-button"> 
                                        <span class="mdc-button__ripple"></span>
                                        <span class="mdc-button__label">My Blog</span> 
                                    </a>  
                                </div>
                                <div> 
                                    <a href="about.php" class="mdc-button"> 
