	    ...
	    <div class="theme-container">  
	        <div class="row center-xs middle-xs my-5"> 
	            <div class="mdc-card p-3 p-relative mw-500px">
	                ...
	                @csrf 
	                <input type="hidden" name="route_name" value="signup"> 
	                    ...
	                    <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon w-100 mt-3 custom-field ">
	                        ...
	                        <input class="mdc-text-field__input" type="text" name="name" value="{{old('name')}}" required autofocus>
	                        <div class="mdc-notched-outline">
	                            <div class="mdc-notched-outline__leading"></div>
	                            <div class="mdc-notched-outline__notch">
	                    ...
	                    <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon w-100 mt-3 custom-field ">
	                        ...
	                        <input class="mdc-text-field__input" type="email" name="email" value="{{old('email')}}" required autofocus>
	                        <div class="mdc-notched-outline">
	                            <div class="mdc-notched-outline__leading"></div>
	                            <div class="mdc-notched-outline__notch">
	                    ...
	                    <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon w-100 mt-3 custom-field ">
	                        ...
	                        <input class="mdc-text-field__input" type="tel" name="phone" value="{{old('phone')}}" required>
	                        <div class="mdc-notched-outline">
	                            <div class="mdc-notched-outline__leading"></div>
	                            <div class="mdc-notched-outline__notch">
