            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>Terms &amp; Conditions</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <h4 class="listing-head">Terms &amp; Conditions</h4>
                        ...
                        <div class="col-sm-12">
                            <div class="section pt-0">
                                <div class="px-0">
                                    ...
                                    <p class="px-3">These terms and conditions will govern your use of our website. You agree that you have read, understand, and agree to be bound by the following terms and conditions in full. Do not use our website if you do not agree with any part of these terms and conditions. We will require you to accept these terms and conditions expressly before you register on our website, post any content there, or use any of our online services.</p>
                                    <ul>
                                        <li>Use a web browser to navigate the pages of our website.</li>
                                        <li>Subject to the other provisions of this agreement.</li>
                                        <li>Save pages from our website to the cache of a web browser.</li>
                                        <li>Please print pages from our website.</li>
                                        <li>Visit our website to listen to music and watch videos.</li>
                                        <li>To access our website’s services, use a web browser.</li>
                                    </ul>
                                    <p class="px-3">
                                    You must not try to circumvent or bypass any access restriction mechanisms on our website. We hold the right to limit access to specific portions of our website, or even our entire website, at our discretion.
                                    </p>
                                    <strong class="px-3">Suitable use You cannot:</strong>
                                    <ul>
                                        <li>Use our website in any way or take any action that compromises its functionality, availability, or accessibility or that could compromise it.</li>
                                        <li>Use our website for any purpose or conduct that is unlawful, illegal, fraudulent, harmful, or in connection with any of these activities.</li>
                                        <li>Copying, storing, hosting, transmitting, sending, using, publishing, or disseminating any material that contains (or is related to) spyware, a computer virus, a Trojan horse, a worm, a keystroke logger, a rootkit, or other harmful computer software is strictly prohibited on our website.</li>
                                        <li>Use our website or any portion of it for any systematic or automated data collection activities (including, but not limited to, scraping, data mining, data extraction, and data harvesting) without our express written permission.</li>
                                        <li>Access or interact with our website using any robot, spider, or other automated means, unless necessary for search engine indexing.</li>
                                        <li>Disobey the instructions in our website’s robots.txt file or use information obtained from it for direct marketing purposes (including, without limitation, email marketing, SMS marketing, telemarketing, and direct mailing).
                                            <br>
                                            You may not contact people, businesses, or other people or entities using information obtained from our website.
                                        </li>
                                        <li>You are responsible for making sure that all the information you give us via our website or in connection with our website is true, accurate, up-to-date, comprehensive, and not deceptive. Your writing: license “Your Content” is referred to in these terms and conditions as all works and materials (including without limitation text, graphics, images, audio, video, and audio-visual material, scripts, software, and files) that you submit to us or our website for publication or storage on, processing by, or transmission through</li>
