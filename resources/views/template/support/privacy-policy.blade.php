            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>Privacy Policy</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <h4 class="listing-head">Privacy Policy</h4>
                        ...
                        <div class="col-sm-12">
                            <div class="section pt-0">
                                <div class="px-0">
                                    ...
                                    <p class="px-3">If any website visitors want to utilize our Service, they should be aware of our rules concerning the gathering, use, and sharing of their Personal Information.</p>
                                    <p class="px-3">
                                    You consent to the gathering and use of your information in accordance with this policy if you choose to use our Service. The Personal Information we gather is used to deliver and enhance the Service. We won’t use or disclose your information in any other way than what is stated in this privacy statement.
                                    </p>
                                    <p class="px-3">
                                    Unless otherwise specified in this Privacy Policy, the terminology used herein have similar meanings as similar to those found in our Terms and Conditions, which are available at.
                                    </p>
                                    <strong class="px-3">
                                    Information Gathering and Utilization:
                                    </strong>
                                    <p class="px-3">
                                    We might ask you for certain personally identifying information, such as your name, contact information, and address, so that you can have a better experience using our Service. We will use the data we gather to get in touch with or recognize you.
                                    </p>
                                    <strong class="px-3">
                                    Data Gathering:
                                    </strong>
                                    <p class="px-3">
                                    We would like to let you know that we automatically gather “Log Data” from your browser whenever you use our Service. Your computer’s Internet Protocol IP address, the version of your browser, the websites you visit while using our Service, the time and date of such visits, how long you spend on each page, and other data may be included in this Log Data.
                                    </p>
                                    <strong class="px-3">
                                    Cookies:
                                    </strong>
                                    <p class="px-3">
                                    Cookies are little data files that are frequently utilized as unique anonymous identifiers. These are downloaded to your computer’s hard drive from the website you visited and transmitted to your browser.
                                    </p>
                                    <p class="px-3">
                                    These “cookies” are used on our website to gather data and enhance our Service. These cookies are available for acceptance or rejection, and you are informed when one is being delivered to your computer. You might not be able to use all of our Services if you decide to reject our cookies.
                                    </p>
                                    <strong class="px-3">
                                    Security:
                                    </strong>
