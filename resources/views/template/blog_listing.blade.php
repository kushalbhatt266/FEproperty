            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>{{$blog[0]->content_name}}</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <h4 class="listing-head">{{$blog[0]->content_name}}</h4>
                  ...
                  <article class="blog-post">
                     <a href="{{url('/blogs/'.$name.'/'.$data->id)}}" class="tdh">
                        <img src="{{config('constant.media_site')}}storage/blog-image/{{$data->image}}" class="img-b"></a>
                     <header class="mt-3">
                        <a href="{{url('/blogs/'.$name.'/'.$data->id)}}" class="tdh">
                           <h2>{{$data->title}}</h2>
                        </a>
                     ...
                     <a href="{{url('/blogs/'.$name.'/'.$data->id)}}" class="btnsearch tdh mb-3" style="color:#fff">Read More <i class="fas fa-chevron-right"></i></a>
                  </article>
                  @endforeach
