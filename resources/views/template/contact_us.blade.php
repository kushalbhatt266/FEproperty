            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>CONTACT US</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <h4 class="listing-head">CONTACT US</h4>
                        <div class="row search_by_row">
                            <div class="col-sm-12 ">
                                <div class="row around-xs">
                                    <div class="col-xs-12 col-sm-4">
                                        <div class="column center-xs middle-xs text-center">
                                        <i class="fa fa-map-marker icon_s" aria-hidden="true"></i>
                                            <h3 class="primary-color py-1">ADDRESS :</h3>
                                            <span class="text-muted fw-500">959 Periwinkle Way</span>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-4">
                                        <div class="column center-xs middle-xs text-center">
                                        <i class="fa fa-phone icon_s" aria-hidden="true"></i>
                                            <h3 class="primary-color py-1">PHONES :</h3>
                                        
                                            <span class="text-muted fw-500"><a href="tel:239-494-0455" style="color:#0000008a;">239-494-0455</a></span>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-4">
                                        <div class="column center-xs middle-xs text-center">
                                        <i class="fa fa-envelope icon_s" aria-hidden="true"></i>
                                            <h3 class="primary-color py-1">E-MAIL :</h3>
                                            <span class="text-muted fw-500"><a href="mailto:hello@nancyehlen.com" style="color:#0000008a;">hello@nancyehlen.com</a></span>
