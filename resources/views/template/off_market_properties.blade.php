                                ...
                                <div class="project-single" data-aos="fade-up">
                                    <div class="project-inner project-head">
                                        <div class="project-bottom">
                                            <h4><a href="{{ route('property.off-market-property-details',[$search_data->id]) }}">View Property</a></h4>
                                        </div>
                                        ...
                                        <div class="homes">
                                            ...
                                            <a href="{{ route('property.off-market-property-details',[$search_data->id]) }}" class="homes-img">
                                                ...
                                                <img src="{{$media->file?config('constant.media_site').'storage/property_image/'.$media->file:config('constant.no_property_image')}}" alt="home-1" class="img-responsive">
                                            </a>
                                        </div>
                                        @endif
                                                    @endforeach
                                    ...
                                    <div class="homes-content">
                                        <!-- homes address -->
                                        <h3><a href="single-property-1.html">{{$search_data->title}}</a></h3>
                                        ...
                                        <ul class="homes-list clearfix pb-3">
                                            ...
                                            <li class="the-icons">
                                                ...
                                                <span>{{$search_data->additionalDetails->garage}} Garages</span>
                                            </li>
                                        </ul>
                                        <!-- Price -->
                                        <div class="price-properties">
                                            <h3 class="title mt-3">
                                        <a href="{{ route('property.off-market-property-details',[$search_data->id]) }}">$ {{$search_data->rental_price}}</a>
                                        </h3>
                                            <div class="compare">
                                               <a href="{{ route('property.off-market-property-details',[$search_data->id]) }}" class="listing_btn">View Details</a>
                                            </div>
                                        </div>
