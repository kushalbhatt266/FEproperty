    ...
    <section class="single-proper blog details">
            <div class="container">
                <div class="row">
                                    ...
                                    <div class="pro-wrapper">
                                        <div class="detail-wrapper-body">
                                            <div class="listing-title-bar">
                                                <h3>{{ $property_details->ListOfficeName }}</h3>
                                                <div class="mt-0">
                                                   
                                                    <a  class="listing-address">
                                                        <i class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>{{$property_details->UnparsedAddress}}, {{$property_details->City}}, {{$property_details->StateOrProvince}} {{$property_details->PostalCode}}, USA
                                                    </a>
                                        ...
                                        <div class="single detail-wrapper mr-2">
                                            <div class="detail-wrapper-body">
                                                <div class="listing-title-bar">
                                                    <h4>$ {{$property_details->ListPrice}}</h4>
                        ...
                        <div class="col-md-12 seimg">
                               ...
                               <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        @foreach($property_details->media as $ls=> $media_thumb)
                                        @if($ls == 0)
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="{{$media_thumb->MediaURL?config('constant.media_site').$media_thumb->MediaURL:config('constant.no_property_image')}}" alt="First slide" style="height: auto;">
                                            </div>
                                        @else
                                        ...
                                        @else
                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{asset(config('constant.no_property_image'))}}" alt="First slide" style="height: auto;">
                                            </div>
                                        @endif
                                        ...
                                        @foreach($property_details->media as $ls=> $media_thumb)
                                        @if($ls == 0)
                                            <li data-target="#carousel-thumb" data-slide-to="{{$ls}}" class="active"> <img class="d-block w-100" src="{{$media_thumb->MediaURL?config('constant.media_site').$media_thumb->MediaURL:config('constant.no_property_image')}}"
                                                class="img-fluid" style="height: auto;"></li>
                                        @else
                                             <li data-target="#carousel-thumb" data-slide-to="{{$ls}}" class=""> <img class="d-block w-100" src="{{$media_thumb->MediaURL?config('constant.media_site').$media_thumb->MediaURL:config('constant.no_property_image')}}"
                                                class="img-fluid" style="height: auto;"></li>
                                        @endif
                                         @endforeach
                                        @else
                    ...
                    <div class="col-lg-8 col-md-12 blog-pots mt-4">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="single homes-content details mb-30">
                            ...
                            <ul class="homes-list clearfix">
                                ...
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    ...
                                    <span class="det">{{$property_details->PropertyType}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Property Subtype:</span>
                                    <span class="det">{{$property_details->PropertySubType}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Listing Status:</span>
                                    <span class="det">{{$property_details->MlsStatus}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">County/Area:</span>
                                    <span class="det">{{$property_details->CountyOrParish}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">City:</span>
                                    <span class="det">{{$property_details->City}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Zip Code:</span>
                                    <span class="det">{{$property_details->PostalCode}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Year Built:</span>
                                    <span class="det">{{$property_details->YearBuilt}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Subdivision/Neighborhood:</span>
                                    <span class="det">{{$property_details->SubdivisionName}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Street:</span>
                                    <span class="det">{{$property_details->StreetName}}</span>
                                </li>
                                ...
                                <li>
                                 <i class="fa fa-check-square" aria-hidden="true"></i>
                                    ...
                                    <span class="det">{{$property_details->BathroomsTotalInteger}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Bathrooms:</span>
                                    <span class="det">{{$property_details->BedroomsTotal}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Garages:</span>
                                    <span class="det">{{$property_details->GarageSpaces}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Property size:</span>
                                    <span class="det">{{$property_details->LotSizeSquareFeet}} ft²</span>
                                </li>
                        ...
                        <div class="single homes-content details mb-30">
                            ...
                            <!-- Features  -->
                            <h5 class="mb-4">ADDITIONAL FEATURES</h5>
                            <ul class="homes-list clearfix">
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Heat:</span>
                                    <span class="det">{{isset($property_details->Heating)?$property_details->Heating:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Roof:</span>
                                    <span class="det">{{isset($property_details->Roof)?$property_details->Roof:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Floors:</span>
                                    <span class="det">{{isset($property_details->Flooring)?$property_details->Flooring:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Water:</span>
                                    <span class="det">{{isset($property_details->WaterSource)?$property_details->WaterSource:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Cooling:</span>
                                    <span class="det">{{isset($property_details->Cooling)?$property_details->Cooling:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Appliances:</span>
                                    <span class="det">{{isset($property_details->Appliances)?$property_details->Appliances:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Additional Roomd:</span>
                                    <span class="det">{{isset($property_details->MFR_AdditionalRooms)?$property_details->MFR_AdditionalRooms:'N/A'}}</span>
                                </li>
                               
                            </ul>
                            <!-- End Features  -->
                            <!-- title -->
                            <h5 class="mt-5 d-none">Amenities</h5>
                            <!-- cars List -->
                            <ul class="homes-list clearfix d-none">
                                <li>
                                    <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span>Heat:</span>
                                </li>
                        ...
                        <!-- Features  -->
                         ...
                         <div class="single homes-content details mb-30">
                            ...
                            <ul class="homes-list clearfix">
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Community Features:</span>
                                    <span class="det">{{isset($property_details->CommunityFeatures)?$property_details->CommunityFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Exterior Features:</span>
                                    <span class="det">{{isset($property_details->ExteriorFeatures)?$property_details->ExteriorFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Fireplace Features:</span>
                                    <span class="det">{{isset($property_details->FireplaceFeatures)?$property_details->FireplaceFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Interior Features:</span>
                                    <span class="det">{{isset($property_details->InteriorFeatures)?$property_details->InteriorFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Laundry Features:</span>
                                    <span class="det">{{isset($property_details->LaundryFeatures)?$property_details->LaundryFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Lot Features:</span>
                                    <span class="det">{{isset($property_details->LotFeatures)?$property_details->LotFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Parking Features:</span>
                                    <span class="det">{{isset($property_details->ParkingFeatures)?$property_details->ParkingFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Patio And Porch Features:</span>
                                    <span class="det">{{isset($property_details->PatioAndPorchFeatures)?$property_details->PatioAndPorchFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Pool Features:</span>
                                    <span class="det">{{isset($property_details->PoolFeatures)?$property_details->PoolFeatures:'N/A'}}</span>
                                </li>


                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Security Features:</span>
                                    <span class="det">{{isset($property_details->SecurityFeatures)?$property_details->SecurityFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Spa Features:</span>
                                    <span class="det">{{isset($property_details->SpaFeatures)?$property_details->SpaFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Waterfront Features:</span>
                                    <span class="det">{{isset($property_details->WaterfrontFeatures)?$property_details->WaterfrontFeatures:'N/A'}}</span>
                                </li>
                                <li>
                                <i class="fa fa-check-square" aria-hidden="true"></i>
                                    <span class="font-weight-bold mr-1">Window Features:</span>
                                    <span class="det">{{isset($property_details->WindowFeatures)?$property_details->WindowFeatures:'N/A'}}</span>
                                </li>
                        ...
                        <div class="floor-plan property wprt-image-video w50 pro d-none">
                            <h5>Floor Plans</h5>
                        ...
                        <div class="property wprt-image-video w50 pro vid-si2 d-none">
                        ...
                        <!-- Star Reviews -->
                        <section class="reviews comments d-none">
                            <h3 class="mb-5">3 Reviews</h3>
                            <div class="row mb-5">
                                <ul class="col-12 commented pl-0">
                                    <li class="comm-inf">
                                        <div class="col-md-2">
                                            <img src="{{asset('frontend/images/testimonials/ts-5.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="col-md-10 comments-info">
                                            ...
                                            <div class="rest"><img src="{{asset('frontend/images/single-property/s-1.jpg')}}" class="img-fluid" alt=""></div>
                                        </div>
                                    </li>
                            ...
                            <div class="row">
                                <ul class="col-12 commented pl-0">
                                    <li class="comm-inf">
                                        <div class="col-md-2">
                                            <img src="{{asset('frontend/images/testimonials/ts-4.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="col-md-10 comments-info">
                                            <div class="conra">
                            ...
                            <div class="row mt-5">
                                <ul class="col-12 commented mb-0 pl-0">
                                    <li class="comm-inf">
                                        <div class="col-md-2">
                                            <img src="{{asset('frontend/images/testimonials/ts-3.jpg')}}" class="img-fluid" alt="">
                                        </div>
                                        <div class="col-md-10 comments-info">
                                            <div class="conra">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras aliquam, quam congue dictum luctus, lacus magna congue ante, in finibus dui sapien eu dolor. Integer tincidunt suscipit erat, nec laoreet ipsum vestibulum sed.</p>
                                            <div class="resti">
                                                <div class="rest"><img src="{{asset('frontend/images/single-property/s-2.jpg')}}" class="img-fluid" alt=""></div>
                                                <div class="rest"><img src="{{asset('frontend/images/single-property/s-3.jpg')}}" class="img-fluid" alt=""></div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <!-- End Reviews -->
                        <!-- Star Add Review -->
                        <section class="single reviews leve-comments details d-none">
                    ...
                    <aside class="col-lg-4 col-md-12 car mt-4">
                        <div class="single widget">
                            <!-- Start: Schedule a Tour -->
                            <div class="schedule widget-boxed mt-30 d-none">
                                    ...
                                    <div class="widget-boxed-body">
                                        <div class="sidebar-widget author-widget2">
                                            <div class="author-box clearfix">
                                                ...
                                                <h4 class="author__title">{{isset($property_details->ListAgentFullName)?$property_details->ListAgentFullName:'N/A'}}</h4>
                                                <p class="author__meta">Agent of Property</p>
                                            </div>
                                            <ul class="author__contact">
                                                <!-- <li><span class="la la-map-marker"><i class="fa fa-map-marker"></i></span>302 Av Park, New York</li> -->
                                                <li><span class="la la-phone"><i class="fa fa-phone" aria-hidden="true"></i></span><a href="tel:{{isset($property_details->ListAgentDirectPhone)?$property_details->ListAgentDirectPhone:'N/A'}}">{{isset($property_details->ListAgentDirectPhone)?$property_details->ListAgentDirectPhone:'N/A'}}</a></li>
                                                <li><span class="la la-envelope-o"><i class="fa fa-envelope" aria-hidden="true"></i></span><a href="mailto:{{isset($property_details->ListAgentEmail)?$property_details->ListAgentEmail:'N/A'}}">{{isset($property_details->ListAgentEmail)?$property_details->ListAgentEmail:'N/A'}}</a></li>
                                            </ul>
                ...
                <section class="similar-property featured portfolio p-0 bg-white-inner d-none">
                    <div class="container">
