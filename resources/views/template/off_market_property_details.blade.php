                ...
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <section class="headings-2 pt-0">
                                    <div class="pro-wrapper">
                                            ...
                                            <div class="listing-title-bar">
                                                ...
                                                <div class="mt-0">
                                                    ...
                                                    <a  class="listing-address">
                                                        <i class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>{{$property_details->address}}
                                                    </a>
                                        ...
                                        <div class="single detail-wrapper mr-2">
                                            <div class="detail-wrapper-body">
                                                <div class="listing-title-bar">
                                                    <h4>$ {{$property_details->rental_price}}/Month</h4>
                        ...
                        <div class="row">
                                    ...
                                    @foreach($property_details->images as $ls =>$media)
                                        @if($ls == 0)
                                            <div class="carousel-item active">
                                                <img class="d-block w-100" src="{{$media->file?config('constant.media_site').'storage/property_image/'.$media->file:config('constant.no_property_image')}}" alt="First slide" style="height: auto;">
                                            </div>
                                        @else
                                        ...
                                        @foreach($property_details->images as $ls=> $media)
                                        @if($ls == 0)
                                            <li data-target="#carousel-thumb" data-slide-to="{{$ls}}" class="active"> <img class="d-block w-100" src="{{$media->file?config('constant.media_site').'storage/property_image/'.$media->file:config('constant.no_property_image')}}"
                                                class="img-fluid" style="height: auto;"></li>
                                        @else
                                             <li data-target="#carousel-thumb" data-slide-to="{{$ls}}" class=""> <img class="d-block w-100" src="{{$media->file?config('constant.media_site').'storage/property_image/'.$media->file:config('constant.no_property_image')}}"
                                                class="img-fluid" style="height: auto;"></li>
                                        @endif
                                         @endforeach
                                        @else
                        ...
                        <div class="single homes-content details mb-30">
                            ...
                            <ul class="homes-list clearfix">
                                <li>
                                    ...
                                    <span class="det">{{$property_details->category->name}}</span>
                                </li>
                                <li>
                               
                                    <span class="font-weight-bold mr-1">Property Subtype:</span>
                                    <span class="det">{{$property_details->subcategory->subcategory}}</span>
                                </li>
                                <li>
                               
                                    <span class="font-weight-bold mr-1">Year Built:</span>
                                    <span class="det">{{$property_details->additionalDetails->built_year}}</span>
                                </li>
                                <li>
                                
                                    <span class="font-weight-bold mr-1">Bedrooms:</span>
                                    <span class="det">{{$property_details->additionalDetails->rooms}}</span>
                                </li>
                                <li>
                               
                                    <span class="font-weight-bold mr-1">Bathrooms:</span>
                                    <span class="det">{{$property_details->additionalDetails->bathrooms}}</span>
                                </li>
                                <li>
                                
                                    <span class="font-weight-bold mr-1">Garages:</span>
                                    <span class="det">{{$property_details->additionalDetails->garage}}</span>
                                </li>
                                <li>
                               
                                    <span class="font-weight-bold mr-1">Property size:</span>
                                    <span class="det">{{$property_details->additionalDetails->total_area}} ft²</span>
                                </li>
                        ...
                        <div class="single homes-content details mb-30">
                            ...
                            <ul class="homes-list clearfix">
                                <li>
                                    ...
                                    <span class="det">{{isset($property_details->additionalDetails->heating)?$property_details->additionalDetails->heating:'N/A'}}</span>
                                </li>
                                <li>
                                
                                    <span class="font-weight-bold mr-1">Parking:</span>
                                    <span class="det">{{isset($property_details->additionalDetails->parking)?$property_details->additionalDetails->parking:'N/A'}}</span>
                                </li>
                                <li>
                                
                                    <span class="font-weight-bold mr-1">Balconies:</span>
                                    <span class="det">{{isset($property_details->additionalDetails->balconies)?$property_details->additionalDetails->balconies:'N/A'}}</span>
                                </li>
                                    ...
                                    <div class="widget-boxed-body">
                                        <div class="sidebar-widget author-widget2">
                                            <div class="author-box clearfix">
                                                ...
                                                <h4 class="author__title">{{isset($property_details->contact_person)?$property_details->contact_person:'N/A'}}</h4>
                                                <!-- <p class="author__meta">Agent of Property</p> -->
                                            </div>
                                            <ul class="author__contact">
                                                <!-- <li><span class="la la-map-marker"><i class="fa fa-map-marker"></i></span>302 Av Park, New York</li> -->
                                                <li><span class="la la-phone"><i class="fa fa-phone" aria-hidden="true"></i></span><a href="tel:{{isset($property_details->contact)?$property_details->contact:'N/A'}}">{{isset($property_details->contact)?$property_details->contact:'N/A'}}</a></li>
