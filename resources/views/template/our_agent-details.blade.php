            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>{{$detail->name}}</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="">
                                    ...
                                    <img src="{{$detail->photo??asset('user.jpg')}}" alt="">
                            ...
                            <div class="col-md-9 agent-info">
                               <div class="row">
                                <div class="col-md-8">
                                    <h4 class="listing-head">{{$detail->name}}</h4>
                                    <p>{{$detail->listing_property}} Listed Properties</p>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="">
                                        <ul class="our-agent-social">
                                            <li><a href="{{$detail->facebook_link}}" class="facebook"><i class="fa fa-facebook"></i></a></li>
                                            <li><a href="{{$detail->twitter_link}}" class="twitter"><i class="fa fa-twitter"></i></a></li>
                                            <li><a href="{{$detail->instagram_link}}" class="instagram"><i class="fa fa-instagram"></i></a></li>
                                            <li><a href="{{$detail->linkdin_link}}" class="linkedin"><i class="fa fa-linkedin"></i></a></li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-md-12">
                                        ...
                                        <ul class="our-agent-otherdetails">
                                            <li><strong>Office : </strong> <span><a href="tel:{{$detail->office_mobile}}">{{$detail->office_mobile}}</a></span></li>
                                            <li><strong>Mobile : </strong> <span><a href="tel:{{$detail->mobile}}">{{$detail->mobile}}</a></span></li>
                                            <li><strong>Fax : </strong> <span><a href="tel:{{$detail->fax}}">{{$detail->fax}}</a></span></li>
                                            <li><strong>WhatsApp : </strong> <span><a href="tel:{{$detail->whatsApp}}">{{$detail->whatsApp}}</a></span></li>
                                            <li><strong>Email : </strong> <span><a href="mailTo:{{$detail->email}}">{{$detail->email}}</a></span></li>
                                        </ul>
                        ...
                        <div class="row search_by_row mt-3">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                            <form id="agent-contact" action="" method="POST" class="contact-form row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 p-2">  
                                        <div class="mdc-text-field mdc-text-field--outlined w-100">
                                            <input type="text" name="name" class="form-control" placeholder="Name is required" required>
                                           
                                        </div> 
                                    </div>  
                                    <div class="col-xs-12 col-sm-12 col-md-4 p-2">  
                                        <div class="mdc-text-field mdc-text-field--outlined w-100">
                                            <input type="email" name="email" class="form-control" placeholder="Email is required" required>
                                           
                                        </div> 
                                    </div>  
                                    <div class="col-xs-12 col-sm-12 col-md-4 p-2">  
                                        <div class="mdc-text-field mdc-text-field--outlined w-100">
                                            <input type="tel" name="phone" class="form-control" placeholder="Phone is required" required>
                                            
                                        </div> 
                                    </div>  
                                    <div class="col-md-12 p-2">  
                                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--textarea w-100">
                                            <textarea name="message" class="form-control" rows="5" placeholder="Message is required" required></textarea>
                                    ...
                                    <div class="col-xs-8 col-sm-12 col-md-8 p-2">
                                        ...
                                        <div class="mdc-text-field mdc-text-field--outlined w-100">
                                            <input type="tel"  class="form-control" id="captchap" placeholder="Enter Captcha Here.." required>
...
@section('scripts')
         ...
         <script>
             var APP_URL = {!! json_encode(url('/')) !!}
               ...
               $('#agent-contact').on("submit",function(e){ 
                    e.preventDefault();
                    $c= $('#captchap').val();
                    $c1= $('#captchap1').val();
                    if($c==$c1)
