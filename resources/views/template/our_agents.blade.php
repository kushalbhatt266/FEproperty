         ...
         <section class="properties-right featured portfolio blog">
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>Our Agents</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots team">
                        <h4 class="listing-head">Our Agents</h4>
                        <div class="row search_by_row">
                              
                        <div class="col-sm-12 team-all row ">
                     @foreach($agents as $agent)   
                    <div class="team-block  mb-4 col-sm-6 col-md-4 col-lg-4 col-xl-4" data-aos="fade-up" data-aos-delay="150">
