            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>MORTGAGE RATES</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        ...
                        <h4 class="listing-head list-header-seller">MORTGAGE RATES</h4>
                        <div class="row search_by_row">
                        <div class="col-md-12 col-xs-12">
                        <h2  style="margin-top: 4%; font-size:18px; padding-bottom:20px;">Current Rates</h2>
                           <table class="wp-table">
                              ...
                              <tr>
                                  <td>30-Year Fixed</td>
                                  <td class='pl-3'>3.01%  </td>
                                  <td>0.7</td>
                              </tr>
                              <tr>
                                  <td>15-Year Fixed</td>
                                  <td class='pl-3'>2.28%</td>
                                  <td>0.6</td>
                              </tr>
                              <tr>
                                  <td>ARM</td>
                                  <td class='pl-3'>2.48%</td>
                                  <td>0.3</td>
                              </tr>
                           </table> 
                           <br>  
