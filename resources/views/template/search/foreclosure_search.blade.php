            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>FORECLOSURE SEARCH</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <h4 class="listing-head">FORECLOSURE SEARCH</h4>
                        <div class="row">
                                    ...
                                    <div class="card_go">  
                                        <form action="javascript:void(0);" id="filters" class="search-wrapper m-0 o-hidden"> 
                                            <div class="column p-2">  
                                                <div class="row">
                                                    <div class="col-md-12">
                                                    <input type="text" class="form-control" name="location" id="location_search" value="{{app('request')->input('location')}}" placeholder="Type address, City or Zipcode">
                                                    </div>   
                                                </div>
                                            
                                                <div class="row">
                                                    <div class="col-md-6 mt-4">
                                                    <input name="min_price" id="search_min_price" value="{{app('request')->input('min_price')}}" class="form-control" placeholder="Price From">
                                                    </div>
                                                    <div class="col-md-6  mt-4">
