            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>Advance Search</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <h4 class="listing-head">Advance Search</h4>
                        <div class="row search_by_row advance_searches">

                            <div class="col-md-12">
                                        <div class="search">
                                           <label for="search_by" style="font-size: 22px;">Search By:</label>
                                           <select name="search_by" id="search_by" class="form-control" onchange="searchBy(this)">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <div class="card_go">
                                            <div class="row">
                                                ...
                                                <p>Bedrooms</p>
                                                    <form>
                                                    <select name="bedrooms" id="search_bedrooms" class="lc form-control" >
                                                    ...
                                                    <p>Lot Size</p>
                                                    <form>
                                                    <select name="lot_size" id="search_lot_size" class="lc form-control">
                                                    <option value="any" selected="selected">Any</option>
                                                    ...
                                                    <p>Total Rooms</p>
                                                    <form>
                                                    <select name="rooms" id="search_rooms" class="lc form-control">
                                                    ...
                                                    <p>Sq.ft.</p>
                                                    <form>
                                                    <select name="sqft" id="search_sqft" class="lc form-control">
                                                    <option value="any">Any</option>
                                                    ...
                                                    <p>Units</p>
                                                    <form>
                                                    <select name="units" id="search_units" class="lc form-control">
                                                    <option value="any">Any</option>
                                                    ...
                                                    <p>Built Before</p>
                                                    <form>
                                                    <select name="built_before" id="search_built_before" class="lc form-control">
                                                    ...
                                                    <p>Built After</p>
                                                    <form>
                                                    <select name="built_after" id="search_built_after" class="lc form-control">
                                                    <option value="any">Any Year</option>
                                                    <option value="2021">2021</option>
                                                    <option value="2020">2020</option>
                                                    <option value="2019">2019</option>
                                                ...
                                                <p>Bathrooms</p>
                                                <form>
                                                <select name="bathrooms" id="search_bathrooms" class="lc form-control">
                                                <option value="any" selected="selected">Any</option>
                                                <option value="1">1 or More</option>
                                                <option value="2">2 or More</option>
                                                <option value="3">3 or More</option>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="card_go">
                                        <div class="row">
                                            ...
                                            <p>Min Price</p>
                                            <form>
                                            <select name="min_price" id="search_min_price" class="lc form-control">
                                            ...
                                            <p>Max Price</p>
                                            <form>
                                            <select name="max_price" id="search_max_price" class="lc form-control">   
