            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>{{request()->get('tag')?request()->get('tag'):'Blog Listing'}}</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <h4 class="listing-head">{{request()->get('tag')?request()->get('tag'):'Blog Listing'}}</h4>
                        ...
                        ?>
                            ...
                            <header><a href="{{url('/news/'.$name.'/'.$blog_data->id)}}" class="tdh"><h2>{{$blog_data->title}}</h2></a></header>
                            <figure class="meta">
                                <a href="#" class="link-icon tdh">
                           ...
                           <p class="ta1">{!! substr($blog_data->description,0,257) !!}
                            ...
                            <a href="{{url('/news/'.$name.'/'.$blog_data->id)}}" class="tdh btnsearch" style="color:#fff">Read More &nbsp;<i class="fas fa-chevron-right"></i></a>
                            </article>
                            <br>
                            @endif
                            @endforeach
