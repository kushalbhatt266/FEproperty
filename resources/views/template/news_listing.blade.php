            ...
            <div class="container">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p class="pb-2"><a href="{{asset('/')}}">Home </a> &nbsp;/&nbsp; <span>{{request()->get('tag')?request()->get('tag'):'Industry News'}}</span></p>
                                </div>
                ...
                @include('template.search')
                    <div class="col-lg-8 col-md-12 blog-pots">
                        <h4 class="listing-head">{{request()->get('tag')?request()->get('tag'):'Industry News'}}</h4>
                  ...
                  <article class="blog-post">
                     <a href="{{url('/news/'.$name.'/'.$data->id)}}" class="tdh"><img src="assets/images/props/flat-2/1-big.jpg" class="img-b"></a>
                     <header class="mt-3">
                        <a href="{{url('/news/'.$name.'/'.$data->id)}}" class="tdh">
                           <h2>{{$data->title}}</h2>
                        </a>
                     </header>
                     <figure class="meta">
                        <a href="{{url('/news/'.$name.'/'.$data->id)}}" class="link-icon tdh"><i class="fa fa-user"></i> &nbsp;{{$data->publish}}</a>
                     ...
                     <a href="{{url('/news/'.$name.'/'.$data->id)}}" class="btnsearch tdh mb-3" style="color:#fff">Read More <i class="fas fa-chevron-right"></i></a>
                  </article>
                  @endforeach
