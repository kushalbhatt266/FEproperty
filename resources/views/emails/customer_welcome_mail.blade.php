								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="90%">
											<table width="100%" cellpadding="0" cellspacing="0" border="0">
												<tr>
													<td>
														<img style="width:200px;" src="{{ $message->embed(public_path() . '/assets/images/main_logo-textchanges.png') }}">
													</td>
												</tr>

												<tr>
													<td height="15" style="border-bottom:3px solid #da251d"></td>
												</tr>
												...
												<tr>
													<td style="color:#000; line-height:1.1em; font-size:1.2em;">Hi <span style="font-weight:bold">{{ $data['name'] }}</span>, Welcome to Nancy EHLEN</td>
												</tr>
												...
												<tr>
													<td style="font-size:1em; line-height:2.6em;font-weight:bold;">Your account has been created successfully</td>
												</tr>
												<tr>
													<td style="font-size:1em; line-height:2.6em;font-weight:bold;"><a href="{{ route('login') }}">Login</a></td>
												</tr>
												...
												<tr>
													<td width="33%" style="text-align:left; text-decoration:none; color:#da251d; font-weight: bold; font-size: 1.4em">Team Nancy EHLEN</td></td>
												</tr>
											</table>
										</td>
									</tr>
									...
									<tr>
										<td>
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td width="30"><a href=""><img src=""></a></td>
												<td width="30"><a href=""><img src=""></a></td>
												<td></td>
											</tr>
											</table>
