        ...
        <div id="top-toolbar" class="mdc-top-app-bar"> 
            <div class="theme-container row between-xs middle-xs h-100">
                <div class="row start-xs middle-xs">  
                    ...
                    <div class="row start-xs middle-xs fw-500 d-none d-md-flex d-lg-flex d-xl-flex"> 
                        <span class="d-flex center-xs middle-xs item">
                            ...
                            <span class="px-1"> Noah Bressack, Licensed Real Estate Broker <a href="tel:813-494-2595" style="color:#fff;">813-494-2595</a></span>
                        </span>
                        <span class="d-flex center-xs middle-xs item">
                            <i class="material-icons mat-icon-sm">call</i>
                            <span class="px-1"> Maxwell <a href="tel:727-641-2686" style="color:#fff;">727-641-2686</a></span>
                        </span>
                        <span class="v-divider"></span> 
                        <span class="d-flex center-xs middle-xs item">
                            <i class="material-icons mat-icon-sm">location_on</i> 
                            <span class="px-1">401 E. Jackson St Suite 2340 Tampa, FL 33602</span>
                        </span>
                        <span class="v-divider"></span>
                        <span class="d-flex center-xs middle-xs item">
                            <i class="material-icons mat-icon-sm">mail</i>  
                            <span class="px-1"><a href="mailto:sales@feelgreatrealestate.com" style="color:#fff;">sales@feelgreatrealestate.com</a></span>
                        </span>  
                    </div>       
                </div> 
                ...
                <div class="row end-xs middle-xs">
                        ...
                        <div class="mdc-menu mdc-menu-surface user-menu">
                            <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical" tabindex="-1">
                                ...
                                <li>
                                    ...
                                    @csrf
                                    <a href="{{route('logout')}}" class="mdc-list-item" role="menuitem" onclick="event.preventDefault(); this.closest('form').submit();">
                                        <i class="material-icons mat-icon-sm text-muted">power_settings_new</i> 
                                        <span class="mdc-list-item__text px-3">{{ __('Log Out') }}</span>
                                    </a>
                                    </form>
                                </li> 
                            </ul>
                    ...
                    @else
                    <div class="mdc-menu-surface--anchor"> 
                        <a href="{{ route('login') }}" class="mdc-button mdc-ripple-surface"> 
                            <!-- <span class="mdc-button__ripple"></span> -->
                            <span class="mdc-button__label">Login</span>
                        </a> 
                        <a href="{{ route('register') }}" class="mdc-button mdc-ripple-surface"> 
                            <!-- <span class="mdc-button__ripple"></span> -->
        ...
        <div id="main-toolbar" class="mdc-elevation--z2">
            <div class="theme-container row between-xs middle-xs h-100"> 
                <a class="logo" href="{{route('home')}}"> 
                   <img src="{{ asset('assets/images/main_logo-textchanges.png') }}" style="width: 110px;height: 110px; margin-top: -10px;"> 
                </a>  
                <div class="horizontal-menu d-none d-md-flex d-lg-flex d-xl-flex">   
                        ...
                        <a href="javascript:void(0);" class="mdc-button menu-item-has-children">
                         ...
                         <div class="mdc-menu mdc-menu-surface">
                            <div class="mdc-list"> 
                                ...
                                <div> 
                                    <a href="https://orimarte.feelgreat-realestate.com/" target="_blank" class="mdc-button"> 
                                        <span class="mdc-button__ripple"></span>
                                        <span class="mdc-button__label">About Ori</span> 
                                    </a>  
                                </div>
                    ...
                    <div>
                        <a href="{{ route('quick-search') }}" class="mdc-button mdc-button--raised mdc-ripple-upgraded blink" type="submit" style="--mdc-ripple-fg-size:61px; --mdc-ripple-fg-scale:1.94392; --mdc-ripple-fg-translate-start:32.2031px, -1.5px; --mdc-ripple-fg-translate-end:20.7188px, -12.5px;">
                            <span class="mdc-button__ripple"></span>
                            <span class="mdc-button__label" style="color: white;">Buyers</span> 
                        </a>
                        <a href="{{ route('free-market-analysis') }}" class="mdc-button mdc-button--raised mdc-ripple-upgraded blink2" type="submit" style="--mdc-ripple-fg-size:61px; --mdc-ripple-fg-scale:1.94392; --mdc-ripple-fg-translate-start:32.2031px, -1.5px; --mdc-ripple-fg-translate-end:20.7188px, -12.5px;">
                            <span class="mdc-button__ripple"></span>
