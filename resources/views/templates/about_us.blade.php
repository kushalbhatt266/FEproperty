@extends('layouts.app')
@section('title', 'About US :- Nancy EHLEN')
@section('page-heading','About  Us')
<!-- Meta Description -->
@section('meta-description','Nancy EHLEN is the leading real estate company in Tampa Bay. We gives you best brokers who is proficiently trained in all aspects of real estate transactions, mortgages, HUDs, property management and financing. ')
                           ...
                           <div class="row">
                              <div class="col-xs-12 col-sm-12 col-md-12 p-3">
                                 <div class="row start-xs middle-xs">
                                    ...
                                    <h2 class="capitalize fw-600 mx-2">Making Property Dealing Easy & Happier</h2>
                                 </div>
                                 ...
                                 <div class="w-100 text-center mt-5">                
                                    <a href="{{ route('list-search',['featured' => true]) }}" class="mdc-button mdc-button--raised mdc-ripple-upgraded" style="--mdc-ripple-fg-size:68px; --mdc-ripple-fg-scale:1.89812; --mdc-ripple-fg-translate-start:14.75px, -20.2813px; --mdc-ripple-fg-translate-end:22.75px, -16px;">
